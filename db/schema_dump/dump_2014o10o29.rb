Sequel.migration do
  change do
    create_table(:LookUp_scope_of_tax_non_residents) do
      String :LookUp_scope_of_tax_non_residents, :size=>45, :null=>false
      String :comments, :size=>500, :null=>false
      
      primary_key [:LookUp_scope_of_tax_non_residents]
    end
    
    create_table(:LookUp_scope_of_tax_residents) do
      String :scope_of_tax_residents, :size=>45, :null=>false
      String :comments, :size=>500, :null=>false
      
      primary_key [:scope_of_tax_residents]
    end
    ...
    create_table(:Table_currency, :ignore_index_errors=>true) do
      ...
      index [:id_tax_jurisdiction], :name=>:fk_1_Tbl_crc_2_Tbl_tax_jdn_KEY_id_tax_jdn_idx
    end
    ...
    create_table(:Table_type_of_tax, :ignore_index_errors=>true) do
      ...
      foreign_key :scope_of_tax_residents, :LookUp_scope_of_tax_residents, :type=>String, :size=>45, :null=>false, :key=>[:scope_of_tax_residents]
      ...
      foreign_key :scope_of_tax_non_residents, :LookUp_scope_of_tax_non_residents, :type=>String, :size=>45, :null=>false, :key=>[:LookUp_scope_of_tax_non_residents]
      
      index [:scope_of_tax_residents], :name=>:fk_1_Tbl_type_of_tax_2_LUp_scope_of_tax_rdt_KEY_scope_of_ta_idx
      ...
      index [:scope_of_tax_non_residents], :name=>:fk_1_Tbl_type_of_tx_2_LUp_scope_f_tx_n_rdt_KEY_scope_f_tx_n_idx
    end
